 ...
 */
public class EvaluateOrdersFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_search_evaluate_orders, null);
        initView(v);
        return v;
    }

    private void initView(View v) {
        lv_evaluate_orders = (XListView) v.findViewById(R.id.lv_evaluate_orders);
        lv_evaluate_orders.setPullLoadEnable(true);
        lv_evaluate_orders.setPullRefreshEnable(true);
        lv_evaluate_orders.setXListViewListener(new XListView.IXListViewListener() {
            @Override
