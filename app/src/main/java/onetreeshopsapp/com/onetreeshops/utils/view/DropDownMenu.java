...
public class DropDownMenu extends LinearLayout {
    ...
    private int textSelectedColor = 0xff7b1fa2;
    //tab未选中颜色
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i==0) {
                    ...
                    setSlectTabTextColor(tab);
                    System.out.println("距离最近");
                }else if (i==2){
                    setSlectTabTextColor(tab);
                    System.out.println("销量最高");
                }
            }
        });
    ...
    private void setSlectTabTextColor(View target){
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            if (target == tabMenuView.getChildAt(i)) {
                    ((TextView) tabMenuView.getChildAt(i)).setTextColor(getResources().getColor(R.color.black));
                    TextPaint tp = ((TextView) tabMenuView.getChildAt(i)).getPaint();
                    tp.setFakeBoldText(true);
                }
             else {
                ((TextView) tabMenuView.getChildAt(i)).setTextColor(getResources().getColor(R.color.bg_gray_member));
                TextPaint tp = ((TextView) tabMenuView.getChildAt(i)).getPaint();
        ...
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    ((TextView) tabMenuView.getChildAt(i)).setTextColor(getResources().getColor(R.color.black));
                    //(tabMenuView.getChildAt(i)).setBackgroundResource(R.color.check_bg);
                    TextPaint tp = ((TextView) tabMenuView.getChildAt(i)).getPaint();
                    tp.setFakeBoldText(true);
                ...
                ((TextView) tabMenuView.getChildAt(i)).setTextColor(getResources().getColor(R.color.bg_gray_member));
                //(tabMenuView.getChildAt(i)).setBackgroundResource(R.color.white);
                /*((TextView) tabMenuView.getChildAt(i)).setCompoundDrawablesWithIntrinsicBounds(null, null,
                        getResources().getDrawable(menuUnselectedIcon), null);*/
                TextPaint tp = ((TextView) tabMenuView.getChildAt(i)).getPaint();
                tp.setFakeBoldText(false);
